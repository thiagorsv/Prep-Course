...
function mayoriaDeEdad(edad = 22) {
...
function esDiezOCinco(numero = -100) {
...
function estaEnRango(numero = 30) {
...
function esEntero(numero = 10.2) {
  ...
  // Tu código:
  new_numero = Math.floor(numero);
  if(new_numero==numero) return true;
  return false;
}

function fizzBuzz(numero = 9) {
...
function operadoresLogicos(num1 = 6, num2 = 4, num3 = 9) {
...
function esVerdadero(valor = true){
...
function tieneTresDigitos(numero = 777){
